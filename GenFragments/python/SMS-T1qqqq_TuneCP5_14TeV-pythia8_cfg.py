...
scenarios = [
    {'ctau':2.,'mgluino':500,'mlsp':20},
    {'ctau':3.,'mgluino':500,'mlsp':20},
    {'ctau':4.,'mgluino':500,'mlsp':20}
]
...
for scenario in scenarios:
    ...
    generator.RandomizedParameters.append(
        cms.PSet(
            ...
            ConfigDescription = cms.string('mgluino%.0f_mlsp%.0f_ctau%.0f' % (scenario['mgluino'], scenario['mlsp'], scenario['ctau'])),
