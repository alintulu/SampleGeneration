...
# with command line options: SampleGeneration/GenFragments/python/WplusH_HToBB_WToLNu_M-125_TuneCP5_13TeV-powheg-pythia8_UL18.py --python_filename SampleGeneration/Analysis/config/WplusH_HToBB_WToLNu_M-125_TuneCP5_13TeV-powheg-pythia8_UL18.py --eventcontent NANOAODGEN --datatier NANOAOD --fileout file:WplusH_HToBB_WToLNu_M-125_TuneCP5_13TeV-powheg-pythia8_UL18.root --conditions auto:phase1_2022_realistic --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run3 --no_exec --mc -n 1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('SampleGeneration/GenFragments/python/WplusH_HToBB_WToLNu_M-125_TuneCP5_13TeV-powheg-pythia8_UL18.py nevts:1'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:WplusH_HToBB_WToLNu_M-125_TuneCP5_13TeV-powheg-pythia8_UL18.root'),
