...
# with command line options: SampleGeneration/GenFragments/python/VBFHToBB_M-125_dipoleRecoilOn_TuneCP5_13TeV-powheg-pythia8.py --python_filename SampleGeneration/Analysis/config/VBFHToBB_M-125_dipoleRecoilOn_TuneCP5_13TeV-powheg-pythia8.py --eventcontent NANOAODGEN --datatier NANOAOD --fileout file:VBFHToBB_M-125_dipoleRecoilOn_TuneCP5_13TeV-powheg-pythia8.root --conditions auto:phase1_2022_realistic --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run3 --no_exec --mc -n 1
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('SampleGeneration/GenFragments/python/VBFHToBB_M-125_dipoleRecoilOn_TuneCP5_13TeV-powheg-pythia8.py nevts:1'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:VBFHToBB_M-125_dipoleRecoilOn_TuneCP5_13TeV-powheg-pythia8.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('root://cms-xrd-global.cern.ch//store/cmst3/user/adlintul/run3/gridpacks/hbb2022/VBF_H_slc7_amd64_gcc700_CMSSW_10_2_29_VBFHToBB.tgz'),
